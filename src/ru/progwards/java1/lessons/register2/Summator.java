...
//===========================================================
//Класс Summator - сумматор, должен содержать 2 статических метода
//
...
//
//
//        Класс должен корректно реализовывать сложение и вычитание значений целых чисел.
//        При этом вычитание реализовывается через сложение (вызов метода add) уменьшаемого
//        с дополнительным кодом вычитаемого. Для перевода числа в дополнительный код и
//        обратно, если число отрицательное реализовать метод
//private Register toTwosComplement(Register value) по алгоритму:
//        - инвертировать все разряды числа
//        - к результату добавить 1 - использовать класс Counter
